...
public class Controller {
    ...
    @FXML
    public void startAsHost(ActionEvent event) {
        Server server = Server.getInstance();

        if (server.isConnected() || server.isSearching()) return;

        server.setHost(true);
        server.setConnection();

        connectionButton.setText("Hosting...");
        System.out.println("UI: Start as HOST");
    }
    @FXML
    public void startAsClient(ActionEvent event) {
        ...
        server.setHost(false);
        server.setConnection();

        connectionButton.setText("Connecting...");
        System.out.println("UI: Start as CLIENT");
    }
